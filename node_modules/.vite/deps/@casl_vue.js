...
function u(t3, e4) {
  return 1 === e4.length ? e4[0] : new r(t3, (function t4(e5, r2, n3) {
    const o3 = n3 || [];
    for (let n4 = 0, s5 = r2.length; n4 < s5; n4++) {
      const s6 = r2[n4];
      c(e5, s6) ? t4(e5, s6.value, o3) : o3.push(s6);
    }
    return o3;
  })(t3, e4));
}
...
var j = class {
  ...
  parseFieldOperators(t3, e4) {
    ...
    for (let o3 = 0, s5 = n3.length; o3 < s5; o3++) {
      const s6 = n3[o3];
      if (!this.o[s6]) throw new Error(`Field query for "${t3}" may contain only operators or a plain object as a value`);
      p(r2, this.parseField(t3, s6, e4[s6], e4));
    }
    return r2;
  }
  parse(t3) {
    ...
    for (let n3 = 0, o3 = r2.length; n3 < o3; n3++) {
      const o4 = r2[n3], s5 = t3[o4], i4 = this.o[o4];
      if (i4) {
        ...
        p(e4, this.parseInstruction(i4, s5, this.i));
      } else this.s.hasOperators(s5) ? e4.push(...this.parseFieldOperators(o4, s5)) : p(e4, this.parseField(o4, this.u.defaultOperatorName, s5, t3));
    }
...
function m(t3, e4) {
  ...
  switch (r2 ? r2.numberOfArguments : 0) {
    case 1:
      o3 = (e5) => {
        const o4 = n3(e5, r2);
        return _(t3, o4)(e5, s5);
      };
      break;
    case 3:
      o3 = (e5, o4, i4) => {
        const c4 = n3(e5, r2);
        return _(t3, c4)(e5, o4, i4, s5);
      };
      break;
    default:
      o3 = (e5, o4) => {
        const i4 = n3(e5, r2);
        return _(t3, i4)(e5, o4, s5);
      };
  }
  const s5 = Object.assign({}, r2, { interpret: o3 });
  return s5.interpret;
}
function v(t3, e4) {
  return (r2, ...n3) => {
    const o3 = t3(r2, ...n3), s5 = e4.bind(null, o3);
    return s5.ast = o3, s5;
  };
}
...
var u2 = { type: "field", validate(e4, t3) {
  ...
  const n3 = o3 instanceof RegExp ? new o("regex", a3.field, o3) : a3.parse(o3, a3);
...
}, parse(e4, r2, { parse: a3, field: n3, hasOperators: i4 }) {
  const s5 = i4(r2) ? a3(r2, { field: n }) : a3(r2);
  return new o(e4.name, n3, s5);
} };
...
var _2 = { type: "field", validate(e4, t3) {
  ...
  const a3 = "string" == typeof r2 ? new RegExp(r2, o3.query.$options || "") : r2;
  return new o(e4.name, o3.field, a3);
} };
...
// node_modules/.pnpm/@ucast+js@3.1.0/node_modules/@ucast/js/dist/es6m/index.mjs
function e2(r2, t3, e4) {
  for (let n3 = 0, o3 = r2.length; n3 < o3; n3++) if (0 === e4(r2[n3], t3)) return true;
  return false;
}
function n2(r2, t3) {
  return Array.isArray(r2) && Number.isNaN(Number(t3));
}
function o2(r2, t3, e4) {
  if (!n2(r2, t3)) return e4(r2, t3);
  let o3 = [];
  for (let n3 = 0; n3 < r2.length; n3++) {
    const u6 = e4(r2[n3], t3);
...
function u3(r2) {
  return (t3, e4, n3) => {
    const o3 = n3.get(e4, t3.field);
    return Array.isArray(o3) ? o3.some((e5) => r2(t3, e5, n3)) : r2(t3, o3, n3);
  };
}
var c3 = Object.hasOwn || Object.prototype.hasOwnProperty.call.bind(Object.prototype.hasOwnProperty);
var i2 = (r2, t3) => r2[t3];
function f3(r2, t3, e4) {
  const n3 = t3.lastIndexOf(".");
  return -1 === n3 ? [r2, t3] : [e4(r2, t3.slice(0, n3)), t3.slice(n3 + 1)];
}
function s3(t3, e4, n3 = i2) {
  if (e4 === n) return t3;
  if (!t3) throw new Error(`Unable to get field "${e4}" out of ${String(t3)}.`);
  return (function(r2, t4, e5) {
    if (-1 === t4.indexOf(".")) return o2(r2, t4, e5);
    const n4 = t4.split(".");
    let u6 = r2;
    for (let r3 = 0, t5 = n4.length; r3 < t5; r3++) if (u6 = o2(u6, n4[r3], e5), !u6 || "object" != typeof u6) return r3 < t5 - 1 ? void 0 : u6;
    return u6;
  })(t3, e4, n3);
}
function l3(r2, t3) {
...
function p3(r2, e4 = {}) {
  return m(r2, Object.assign({ get: s3, compare: l3 }, e4));
}
var g2 = (r2, t3, { interpret: e4 }) => r2.value.some((r3) => e4(r3, t3));
var b2 = (r2, t3, e4) => !g2(r2, t3, e4);
var m3 = (r2, t3, { interpret: e4 }) => r2.value.every((r3) => e4(r3, t3));
var y3 = (r2, t3, { interpret: e4 }) => !e4(r2.value[0], t3);
var j3 = (r2, t3, { compare: n3, get: o3 }) => {
  const u6 = o3(t3, r2.field);
  return Array.isArray(u6) && !Array.isArray(r2.value) ? e2(u6, r2.value, n3) : 0 === n3(u6, r2.value);
};
var A2 = (r2, t3, e4) => !j3(r2, t3, e4);
var d3 = u3((r2, t3, e4) => {
  const n3 = e4.compare(t3, r2.value);
  return 0 === n3 || -1 === n3;
});
var O3 = u3((r2, t3, e4) => -1 === e4.compare(t3, r2.value));
var h3 = u3((r2, t3, e4) => 1 === e4.compare(t3, r2.value));
var v3 = u3((r2, t3, e4) => {
  const n3 = e4.compare(t3, r2.value);
  return 0 === n3 || 1 === n3;
});
var w3 = (t3, e4, { get: o3 }) => {
  if (t3.field === n) return void 0 !== e4;
  const [u6, i4] = f3(e4, t3.field, o3), s5 = (r2) => null == r2 ? Boolean(r2) === t3.value : c3(r2, i4) === t3.value;
  return n2(u6, i4) ? u6.some(s5) : s5(u6);
};
var _3 = u3((r2, t3) => "number" == typeof t3 && t3 % r2.value[0] === r2.value[1]);
var x3 = (t3, e4, { get: o3 }) => {
  const [u6, c4] = f3(e4, t3.field, o3), i4 = (r2) => {
    const e5 = o3(r2, c4);
    return Array.isArray(e5) && e5.length === t3.value;
  };
  return t3.field !== n && n2(u6, c4) ? u6.some(i4) : i4(u6);
};
var N2 = u3((r2, t3) => "string" == typeof t3 && r2.value.test(t3));
var $2 = u3((r2, t3, { compare: n3 }) => e2(r2.value, t3, n3));
var q2 = (r2, t3, e4) => !$2(r2, t3, e4);
var z2 = (r2, t3, { compare: n3, get: o3 }) => {
  const u6 = o3(t3, r2.field);
  return Array.isArray(u6) && r2.value.every((r3) => e2(u6, r3, n3));
};
var B = (r2, t3, { interpret: e4, get: n3 }) => {
  const o3 = n3(t3, r2.field);
  return Array.isArray(o3) && o3.some((t4) => e4(r2.value, t4));
};
var E2 = (r2, t3) => r2.value.call(t3);
var M = Object.freeze({ __proto__: null, or: g2, nor: b2, and: m3, not: y3, eq: j3, ne: A2, lte: d3, lt: O3, gt: h3, gte: v3, exists: w3, mod: _3, size: x3, regex: N2, within: $2, nin: q2, all: z2, elemMatch: B, where: E2 });
var S = Object.assign({}, M, { in: $2 });
var U = p3(S);

// node_modules/.pnpm/@ucast+mongo2js@1.4.1/node_modules/@ucast/mongo2js/dist/es6m/index.mjs
function i3(o3) {
  return null === o3 || "object" != typeof o3 ? o3 : o3 instanceof Date ? o3.getTime() : o3 && "function" == typeof o3.toJSON ? o3.toJSON() : o3;
}
var m4 = (o3, t3) => l3(i3(o3), i3(t3));
function p4(r2, c4, f4) {
  const s5 = new P(r2), i4 = p3(c4, Object.assign({ compare: m4 }, f4));
  if (f4 && f4.forPrimitives) {
    const o3 = { field: n }, e4 = s5.parse;
    s5.setParse((t3) => e4(t3, o3));
  }
  return v(s5.parse, i4);
}
var u4 = p4(z, S);
var a2 = p4(["$and", "$or"].reduce((o3, t3) => (o3[t3] = Object.assign({}, o3[t3], { type: "field" }), o3), Object.assign({}, z, { $nor: Object.assign({}, z.$nor, { type: "field", parse: O.compound }) })), S, { forPrimitives: true });
...
function U2(t3, i4, e4) {
  for (let s5 = e4; s5 < i4.length; s5++) t3.push(i4[s5]);
}
function G(t3, i4) {
  ...
  let s5 = 0;
  const n3 = [];
  while (e4 < t3.length && s5 < i4.length) if (t3[e4].priority < i4[s5].priority) {
    n3.push(t3[e4]);
    e4++;
  } else {
    n3.push(i4[s5]);
...
var Z = class {
  ...
  rulesFor(t3, i4, e4) {
    const s5 = this.possibleRulesFor(t3, i4);
    ...
    if (!this.h) return s5;
    return s5.filter(((t4) => t4.matchesField(e4)));
  }
  actionsFor(t3) {
    ...
    const s5 = t3 !== this.A ? this.l.get(this.A) : void 0;
    if (s5) Array.from(s5.keys()).forEach(((t4) => i4.add(t4)));
    return Array.from(i4);
  }
  on(t3, i4) {
    this.F = this.F || /* @__PURE__ */ new Map();
    const e4 = this.F;
    const s5 = e4.get(t3) || null;
    const n3 = N3(i4, s5);
    e4.set(t3, n3);
    return () => {
      const i5 = e4.get(t3);
...
var PureAbility = class extends Z {
  can(t3, i4, e4) {
    const s5 = this.relevantRuleFor(t3, i4, e4);
    return !!s5 && !s5.inverted;
  }
  relevantRuleFor(t3, i4, e4) {
    const s5 = this.detectSubjectType(i4);
    const n3 = this.rulesFor(t3, s5, e4);
...
var it = { eq: j3, ne: A2, lt: O3, lte: d3, gt: h3, gte: v3, in: $2, nin: q2, all: z2, size: x3, regex: N2, elemMatch: B, exists: w3, and: m3 };
var st = p4(tt, it);
...
var ForbiddenError = class extends yt {
  ...
  throwUnlessCan(t3, i4, e4) {
    const s5 = this.unlessCan(t3, i4, e4);
    if (s5) throw s5;
  }
  unlessCan(t3, i4, e4) {
    const s5 = this.ability.relevantRuleFor(t3, i4, e4);
    if (s5 && !s5.inverted) return;
    this.action = t3;
    this.subject = i4;
    this.subjectType = T(this.ability.detectSubjectType(i4));
    this.field = e4;
    const n3 = s5 ? s5.reason : "";
...
// node_modules/.pnpm/@casl+vue@2.2.2_@casl+ability@6.7.3_vue@3.5.14_typescript@5.8.3_/node_modules/@casl/vue/dist/es6m/index.mjs
...
var u5 = defineComponent({ name: "Can", props: { I: String, do: String, a: [String, Function], an: [String, Function], this: [String, Function, Object], on: [String, Function, Object], not: Boolean, passThrough: Boolean, field: String }, setup(t3, { slots: i4 }) {
  ...
  const e4 = useAbility();
  return () => {
    const s5 = e4.can(n3[r2], n3[o3], n3.field);
    const u6 = t3.not ? !s5 : s5;
