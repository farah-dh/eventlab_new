...
const sources: BundleScriptConfig = {
  ...
  json: [
    ...
    new URL(import.meta.resolve('@iconify-json/tabler/icons.json')).pathname,
    {
      filename: new URL(import.meta.resolve('@iconify-json/mdi/icons.json')).pathname,
      icons: [
        'close-circle',
        'language-javascript',
        'language-typescript',
    ...
    {
      filename: new URL(import.meta.resolve('@iconify-json/fa/icons.json')).pathname,
      icons: [
        'circle',
      ],
    },
    ...
    // {
    //   filename: import.meta.resolve('@iconify-json/line-md/icons.json'),
    //   icons: [
    //     'home-twotone-alt',
    //     'github',
    //     'document-list',
